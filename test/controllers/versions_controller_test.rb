...
class VersionsControllerTest < ActionController::TestCase
  ...
  test "should create version" do
    assert_difference('Version.count') do
      post :create, version: { header_external: @version.header_external, header_external_link: @version.header_external_link }
    end
  ...
  test "should update version" do
    patch :update, id: @version, version: { header_external: @version.header_external, header_external_link: @version.header_external_link }
    assert_redirected_to version_path(assigns(:version))
  end
